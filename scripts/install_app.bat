...
REM Command to run when opening a file
set "OPEN_COMMAND=\"%CHROME_PATH%\" --user-data-dir=\"%USER_DATA_DIR%\" --allow-file-access-from-files --app=\"%APP_URL%?file=%%1\""
...
reg add "HKCU\Software\Classes\SimplePDFReader.PDF\shell\open\command" /ve /d "%OPEN_COMMAND%" /f
